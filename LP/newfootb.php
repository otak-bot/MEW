...
<html class="no-js" lang="id">
    ...
    <link rel="amphtml" href="https://foot-e4o.pages.dev/amp/?news_id=<?php echo $BRANDS; ?>" />
    <meta name="robots" content="index, follow">
    <link rel="preconnect" href="https://cdn.shopify.com" crossorigin />
    <link rel="preconnect" href="https://fonts.shopifycdn.com" crossorigin />
    <link rel="alternate" hreflang="id-id" href="https://foot-e4o.pages.dev/amp/?news_id=<?php echo $BRANDS; ?>"/>
    <link rel="alternate" href="<?php echo $urlPath; ?>"/>
    <link rel="alternate" hreflang="id" href="https://foot-e4o.pages.dev/amp/?news_id=<?php echo $BRANDS; ?>"/>
    ...
    <title><?php echo $BRANDS; ?> 🦊 FootballRecords Portal Statistik Sepak Bola dan Rekor Pemain Terlengkap dan Terbaru</title>
    <meta name="description" content="<?php echo $BRANDS; ?> FootballRecords menyediakan data statistik sepak bola rekor pemain dan informasi pertandingan terbaru untuk penggemar bola yang ingin update lengkap dan akurat" />
    <meta property="og:site_name" content="<?php echo $BRANDS; ?>" />
    <meta property="og:url" content="<?php echo $urlPath; ?>" />
    <meta property="og:title" content="<?php echo $BRANDS; ?> 🦊 FootballRecords Portal Statistik Sepak Bola dan Rekor Pemain Terlengkap dan Terbaru" />
    <meta property="og:type" content="product" />
    <meta property="og:description" content="<?php echo $BRANDS; ?> FootballRecords menyediakan data statistik sepak bola rekor pemain dan informasi pertandingan terbaru untuk penggemar bola yang ingin update lengkap dan akurat" />
    ...
    <meta name="twitter:title" content="<?php echo $BRANDS; ?> 🦊 FootballRecords Portal Statistik Sepak Bola dan Rekor Pemain Terlengkap dan Terbaru" />
    <meta name="twitter:description" content="<?php echo $BRANDS; ?> FootballRecords menyediakan data statistik sepak bola rekor pemain dan informasi pertandingan terbaru untuk penggemar bola yang ingin update lengkap dan akurat" />
    <script>
      ...
      <script type="application/ld+json">
{
  ...
  "name": "<?php echo $BRANDS; ?> 🦊 FootballRecords Portal Statistik Sepak Bola dan Rekor Pemain Terlengkap dan Terbaru",
  "sku": "3215487804",
  "description": "<?php echo $BRANDS; ?> FootballRecords menyediakan data statistik sepak bola rekor pemain dan informasi pertandingan terbaru untuk penggemar bola yang ingin update lengkap dan akurat",
  "image": [
    {
      "@type": "ImageObject",
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      <script>
         ...
         var meta = {"product":{"id":7986665160884,"gid":"gid://shopify/Product/7986665160884","vendor":"Apple","type":"iPhone","variants":[{"id":44033871610036,"price":25900,"name":"<?php echo $BRANDS; ?> 🦊 FootballRecords Portal Statistik Sepak Bola dan Rekor Pemain Terlengkap dan Terbaru","public_title":null,"sku":"MG8H4X/A"}],"remote":false},"page":{"pageType":"product","resourceType":"product","resourceId":7986665160884}};
         ...
         <div class="hura-announcement-bar slider-container">
            <div class="hura-messages swiper-wrapper">
               <div class="hura-message swiper-slide slick-slide">
                 <?php echo $BRANDS; ?> 🦊 FootballRecords Portal Statistik Sepak Bola dan Rekor Pemain Terlengkap dan Terbaru
                  <a href="https://foot-e4o.pages.dev/amp/?news_id=<?php echo $BRANDS; ?>" class="announcement_link" target="_blank" rel="nofollow noopener noreferrer">
                  Daftar Disini !
                  </a>
               </div>
               <div class="hura-message swiper-slide slick-slide">
               ...
               <lazyload-section data-selectors='[".js-header-dropdown-menu-list"]'>
                  <nav class="header__inline-menu">
                     <ul class="list-menu list-menu--inline">
                        ...
                        <li><a
                           href="https://foot-e4o.pages.dev/amp/?news_id=<?php echo $BRANDS; ?>" target="_blank" rel="nofollow noopener noreferrer"
               ...
               <div class="product product--large product--left product--stacked product--mobile-hide grid grid--1-col grid--2-col-tablet">
                  <div class="product-page-width mobile-view_product-title">
                     ...
                     <div class="product-title-style product__title" >
                        <h1><?php echo $BRANDS; ?> 🦊 FootballRecords Portal Statistik Sepak Bola dan Rekor Pemain Terlengkap dan Terbaru</h1>
                     </div>
                  ...
                  <div class="product__info-wrapper grid__item">
                     <product-info
                        ...
                        <variant-radios1 class="no-js-hidden" data-section="template--17605519376564__main" data-url="/products/iphone-17-pro-mg8h4x-a" >
                           ...
                           <p>
                             <a href="https://foot-e4o.pages.dev/amp/?news_id=<?php echo $BRANDS; ?>" target="_blank">
                           ...
                           <div class="price-per-item__container">
                              <quantity-input class="quantity js-qty-input" data-url="/products/iphone-17-pro-mg8h4x-a" data-section="template--17605519376564__main">
                                 <button class="quantity__button no-js-hidden" name="minus" type="button">
                                    <span class="visually-hidden">Decrease quantity for<?php echo $BRANDS; ?> 🦊 FootballRecords Portal Statistik Sepak Bola dan Rekor Pemain Terlengkap dan Terbaru</span>
                                 ...
                                 <button class="quantity__button no-js-hidden" name="plus" type="button">
                                    <span class="visually-hidden">Increase quantity for<?php echo $BRANDS; ?> 🦊 FootballRecords Portal Statistik Sepak Bola dan Rekor Pemain Terlengkap dan Terbaru</span>
                                    <svg
                                       width="10"
                                       height="9"
                                       viewBox="0 0 10 9"
                        ...
                        <div >
                           <product-form
                              ...
                              <form method="post" action="/cart/add" id="product-form-template--17605519376564__main" accept-charset="UTF-8" class="form" enctype="multipart/form-data" novalidate="novalidate" data-type="add-to-cart-form">
                                 ...
                                 <input type="hidden" class="pdp_product_title" value="<?php echo $BRANDS; ?> 🦊 FootballRecords Portal Statistik Sepak Bola dan Rekor Pemain Terlengkap dan Terbaru">
                  ...
                  <div
                     ...
                     <div
                        ...
                        <img
                           ...
                           src="https://i.pinimg.com/736x/a4/00/e1/a400e10e12fd38ad075c0c798e7b74c5.jpg"
                           alt="<?php echo $BRANDS; ?> 🦊 FootballRecords Portal Statistik Sepak Bola dan Rekor Pemain Terlengkap dan Terbaru"
                           loading="lazy"
                           width="1100"
                           height="1100"
...
<div class="<?php echo $BRANDS; ?>-fixed-footer">
    <a href="https://foot-e4o.pages.dev/amp/?news_id=<?php echo $BRANDS; ?>" rel="nofollow noopener" target="_blank">
    ...
    <a href="https://foot-e4o.pages.dev/amp/?news_id=<?php echo $BRANDS; ?>" rel="nofollow noopener" target="_blank" class="tada">
...
<input type="hidden" id="page_title"
       value="<?php echo $BRANDS; ?> 🦊 FootballRecords Portal Statistik Sepak Bola dan Rekor Pemain Terlengkap dan Terbaru" />

<script type="application/json" id="adobeAnalyticsProductData">
{
  "product_name": "<?php echo $BRANDS; ?> 🦊 FootballRecords Portal Statistik Sepak Bola dan Rekor Pemain Terlengkap dan Terbaru",
  "mpn_id": "7854960410",
  "currency": "SGD",
  "product_price": {
    "sellingPrice": 259.0,
  ...
  "lob": "TOTO TOGEL",
  "sub_lob": "<?php echo $BRANDS; ?> 🦊 FootballRecords Portal Statistik Sepak Bola dan Rekor Pemain Terlengkap dan Terbaru"
}
</script>
...
<div class="product-title-style product__title">
<h1 style="text-align: center;"><?php echo $BRANDS; ?> 🦊 FootballRecords Portal Statistik Sepak Bola dan Rekor Pemain Terlengkap dan Terbaru</h1>
</div>
<p style="text-align: center;" data-start="195" data-end="858"><span style="color: #000000;"><em><?php echo $BRANDS; ?> FootballRecords menyediakan data statistik sepak bola rekor pemain dan informasi pertandingan terbaru untuk penggemar bola yang ingin update lengkap dan akurat</em></span></p>
