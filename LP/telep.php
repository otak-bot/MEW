...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> # Telesperanza Cursos Platform Kursus Online untuk Pengembangan Diri dan Pembelajaran Digital</title>
<link rel="amphtml" href="https://teles-7pn.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> Ikuti berbagai kursus online di Telesperanza untuk meningkatkan pengetahuan dan keterampilan Anda. Platform pembelajaran digital yang mudah diakses dengan materi edukatif berkualitas.">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> # Telesperanza Cursos Platform Kursus Online untuk Pengembangan Diri dan Pembelajaran Digital">
<meta property="og:description" content="<?php echo $BRANDS; ?> Ikuti berbagai kursus online di Telesperanza untuk meningkatkan pengetahuan dan keterampilan Anda. Platform pembelajaran digital yang mudah diakses dengan materi edukatif berkualitas.">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> # Telesperanza Cursos Platform Kursus Online untuk Pengembangan Diri dan Pembelajaran Digital",
      "description": "<?php echo $BRANDS; ?> Ikuti berbagai kursus online di Telesperanza untuk meningkatkan pengetahuan dan keterampilan Anda. Platform pembelajaran digital yang mudah diakses dengan materi edukatif berkualitas.",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> # Telesperanza Cursos Platform Kursus Online untuk Pengembangan Diri dan Pembelajaran Digital",
      "description": "<?php echo $BRANDS; ?> Ikuti berbagai kursus online di Telesperanza untuk meningkatkan pengetahuan dan keterampilan Anda. Platform pembelajaran digital yang mudah diakses dengan materi edukatif berkualitas.",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> # Telesperanza Cursos Platform Kursus Online untuk Pengembangan Diri dan Pembelajaran Digital</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> Ikuti berbagai kursus online di Telesperanza untuk meningkatkan pengetahuan dan keterampilan Anda. Platform pembelajaran digital yang mudah diakses dengan materi edukatif berkualitas.</p>
            </div>
...
<div class="neo-auth">
  <a href="https://teles-7pn.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://teles-7pn.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
