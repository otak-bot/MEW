...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> # TVPU Website Sekolah dengan Informasi Pendidikan dan Kegiatan Akademik</title>
<link rel="amphtml" href="https://tvpu-6uz.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> Akses informasi sekolah kegiatan akademik dan layanan pendidikan melalui TVPU dengan sistem yang mudah dan informatif">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> # TVPU Website Sekolah dengan Informasi Pendidikan dan Kegiatan Akademik">
<meta property="og:description" content="<?php echo $BRANDS; ?> Akses informasi sekolah kegiatan akademik dan layanan pendidikan melalui TVPU dengan sistem yang mudah dan informatif">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> # TVPU Website Sekolah dengan Informasi Pendidikan dan Kegiatan Akademik",
      "description": "<?php echo $BRANDS; ?> Akses informasi sekolah kegiatan akademik dan layanan pendidikan melalui TVPU dengan sistem yang mudah dan informatif",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> # TVPU Website Sekolah dengan Informasi Pendidikan dan Kegiatan Akademik",
      "description": "<?php echo $BRANDS; ?> Akses informasi sekolah kegiatan akademik dan layanan pendidikan melalui TVPU dengan sistem yang mudah dan informatif",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> # TVPU Website Sekolah dengan Informasi Pendidikan dan Kegiatan Akademik</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> Akses informasi sekolah kegiatan akademik dan layanan pendidikan melalui TVPU dengan sistem yang mudah dan informatif</p>
            </div>
...
<div class="neo-auth">
  <a href="https://tvpu-6uz.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://tvpu-6uz.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
