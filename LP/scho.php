...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> # School18 Ternopil Portal Informasi Sekolah dan Aktivitas Pendidikan</title>
<link rel="amphtml" href="https://sch-eyv.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> Temukan informasi terbaru tentang kegiatan akademik pengumuman sekolah dan layanan pendidikan di School18 Ternopil untuk mendukung proses belajar siswa">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> # School18 Ternopil Portal Informasi Sekolah dan Aktivitas Pendidikan">
<meta property="og:description" content="<?php echo $BRANDS; ?> Temukan informasi terbaru tentang kegiatan akademik pengumuman sekolah dan layanan pendidikan di School18 Ternopil untuk mendukung proses belajar siswa">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> # School18 Ternopil Portal Informasi Sekolah dan Aktivitas Pendidikan",
      "description": "<?php echo $BRANDS; ?> Temukan informasi terbaru tentang kegiatan akademik pengumuman sekolah dan layanan pendidikan di School18 Ternopil untuk mendukung proses belajar siswa",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> # School18 Ternopil Portal Informasi Sekolah dan Aktivitas Pendidikan",
      "description": "<?php echo $BRANDS; ?> Temukan informasi terbaru tentang kegiatan akademik pengumuman sekolah dan layanan pendidikan di School18 Ternopil untuk mendukung proses belajar siswa",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> # School18 Ternopil Portal Informasi Sekolah dan Aktivitas Pendidikan</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> Temukan informasi terbaru tentang kegiatan akademik pengumuman sekolah dan layanan pendidikan di School18 Ternopil untuk mendukung proses belajar siswa</p>
            </div>
...
<div class="neo-auth">
  <a href="https://sch-eyv.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://sch-eyv.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
