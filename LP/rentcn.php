...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> # Rent Flat CN Sewa Apartemen dan Hunian Nyaman dengan Harga Terjangkau</title>
<link rel="amphtml" href="https://rent-mvo.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> Rent Flat CN menyediakan layanan sewa apartemen dan hunian dengan pilihan lengkap harga terjangkau dan proses mudah untuk kebutuhan tinggal jangka pendek maupun panjang">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> # Rent Flat CN Sewa Apartemen dan Hunian Nyaman dengan Harga Terjangkau">
<meta property="og:description" content="<?php echo $BRANDS; ?> Rent Flat CN menyediakan layanan sewa apartemen dan hunian dengan pilihan lengkap harga terjangkau dan proses mudah untuk kebutuhan tinggal jangka pendek maupun panjang">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> # Rent Flat CN Sewa Apartemen dan Hunian Nyaman dengan Harga Terjangkau",
      "description": "<?php echo $BRANDS; ?> Rent Flat CN menyediakan layanan sewa apartemen dan hunian dengan pilihan lengkap harga terjangkau dan proses mudah untuk kebutuhan tinggal jangka pendek maupun panjang",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> # Rent Flat CN Sewa Apartemen dan Hunian Nyaman dengan Harga Terjangkau",
      "description": "<?php echo $BRANDS; ?> Rent Flat CN menyediakan layanan sewa apartemen dan hunian dengan pilihan lengkap harga terjangkau dan proses mudah untuk kebutuhan tinggal jangka pendek maupun panjang",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> # Rent Flat CN Sewa Apartemen dan Hunian Nyaman dengan Harga Terjangkau</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> Rent Flat CN menyediakan layanan sewa apartemen dan hunian dengan pilihan lengkap harga terjangkau dan proses mudah untuk kebutuhan tinggal jangka pendek maupun panjang</p>
            </div>
...
<div class="neo-auth">
  <a href="https://rent-mvo.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://rent-mvo.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
