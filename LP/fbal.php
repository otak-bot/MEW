...
<link rel="amphtml" href="https://foot-e4o.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> # FootballRecords Portal Statistik Sepak Bola dan Rekor Pemain Terlengkap dan Terbaru",
      "description": "<?php echo $BRANDS; ?> FootballRecords menyediakan data statistik sepak bola rekor pemain dan informasi pertandingan terbaru untuk penggemar bola yang ingin update lengkap dan akurat",
      "author": {
        "@type": "Person",
...
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> FootballRecords menyediakan data statistik sepak bola rekor pemain dan informasi pertandingan terbaru untuk penggemar bola yang ingin update lengkap dan akurat</p>
            </div>
...
<div class="neo-auth">
  <a href="https://foot-e4o.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://foot-e4o.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
