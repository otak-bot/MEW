...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> # Codesandhai Belajar Coding dengan Mentor Profesional dan Proyek Nyata untuk Karir Digital</title>
<link rel="amphtml" href="https://sandhai.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> Belajar coding bersama mentor berpengalaman di Codesandhai. Kerjakan proyek nyata dan tingkatkan skill Anda untuk membangun karir di dunia teknologi secara cepat dan efektif">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> # Codesandhai Belajar Coding dengan Mentor Profesional dan Proyek Nyata untuk Karir Digital">
<meta property="og:description" content="<?php echo $BRANDS; ?> Belajar coding bersama mentor berpengalaman di Codesandhai. Kerjakan proyek nyata dan tingkatkan skill Anda untuk membangun karir di dunia teknologi secara cepat dan efektif">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> # Codesandhai Belajar Coding dengan Mentor Profesional dan Proyek Nyata untuk Karir Digital",
      "description": "<?php echo $BRANDS; ?> Belajar coding bersama mentor berpengalaman di Codesandhai. Kerjakan proyek nyata dan tingkatkan skill Anda untuk membangun karir di dunia teknologi secara cepat dan efektif",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> # Codesandhai Belajar Coding dengan Mentor Profesional dan Proyek Nyata untuk Karir Digital",
      "description": "<?php echo $BRANDS; ?> Belajar coding bersama mentor berpengalaman di Codesandhai. Kerjakan proyek nyata dan tingkatkan skill Anda untuk membangun karir di dunia teknologi secara cepat dan efektif",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> # Codesandhai Belajar Coding dengan Mentor Profesional dan Proyek Nyata untuk Karir Digital</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> Belajar coding bersama mentor berpengalaman di Codesandhai. Kerjakan proyek nyata dan tingkatkan skill Anda untuk membangun karir di dunia teknologi secara cepat dan efektif</p>
            </div>
...
<div class="neo-auth">
  <a href="https://sandhai.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://sandhai.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
