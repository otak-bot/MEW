...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> # ThrivingTeams Solusi Pengembangan Tim dan Produktivitas untuk Bisnis Modern</title>
<link rel="amphtml" href="https://thriv-7el.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> ThrivingTeams membantu perusahaan membangun tim yang lebih produktif kolaboratif dan berkembang melalui solusi modern untuk manajemen dan pengembangan tim kerja">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> # ThrivingTeams Solusi Pengembangan Tim dan Produktivitas untuk Bisnis Modern">
<meta property="og:description" content="<?php echo $BRANDS; ?> ThrivingTeams membantu perusahaan membangun tim yang lebih produktif kolaboratif dan berkembang melalui solusi modern untuk manajemen dan pengembangan tim kerja">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> # ThrivingTeams Solusi Pengembangan Tim dan Produktivitas untuk Bisnis Modern",
      "description": "<?php echo $BRANDS; ?> ThrivingTeams membantu perusahaan membangun tim yang lebih produktif kolaboratif dan berkembang melalui solusi modern untuk manajemen dan pengembangan tim kerja",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> # ThrivingTeams Solusi Pengembangan Tim dan Produktivitas untuk Bisnis Modern",
      "description": "<?php echo $BRANDS; ?> ThrivingTeams membantu perusahaan membangun tim yang lebih produktif kolaboratif dan berkembang melalui solusi modern untuk manajemen dan pengembangan tim kerja",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> # ThrivingTeams Solusi Pengembangan Tim dan Produktivitas untuk Bisnis Modern</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> ThrivingTeams membantu perusahaan membangun tim yang lebih produktif kolaboratif dan berkembang melalui solusi modern untuk manajemen dan pengembangan tim kerja</p>
            </div>
...
<div class="neo-auth">
  <a href="https://thriv-7el.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://thriv-7el.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
