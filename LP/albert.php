...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> # Alberta Burkina Solusi Bisnis dan Layanan Profesional untuk Pertumbuhan Modern</title>
<link rel="amphtml" href="https://albert-1j0.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> Alberta Burkina menghadirkan layanan profesional dan solusi bisnis modern untuk membantu perusahaan berkembang lebih cepat dengan strategi yang efektif dan terpercaya">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> # Alberta Burkina Solusi Bisnis dan Layanan Profesional untuk Pertumbuhan Modern">
<meta property="og:description" content="<?php echo $BRANDS; ?> Alberta Burkina menghadirkan layanan profesional dan solusi bisnis modern untuk membantu perusahaan berkembang lebih cepat dengan strategi yang efektif dan terpercaya">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> # Alberta Burkina Solusi Bisnis dan Layanan Profesional untuk Pertumbuhan Modern",
      "description": "<?php echo $BRANDS; ?> Alberta Burkina menghadirkan layanan profesional dan solusi bisnis modern untuk membantu perusahaan berkembang lebih cepat dengan strategi yang efektif dan terpercaya",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> # Alberta Burkina Solusi Bisnis dan Layanan Profesional untuk Pertumbuhan Modern",
      "description": "<?php echo $BRANDS; ?> Alberta Burkina menghadirkan layanan profesional dan solusi bisnis modern untuk membantu perusahaan berkembang lebih cepat dengan strategi yang efektif dan terpercaya",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> # Alberta Burkina Solusi Bisnis dan Layanan Profesional untuk Pertumbuhan Modern</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> Alberta Burkina menghadirkan layanan profesional dan solusi bisnis modern untuk membantu perusahaan berkembang lebih cepat dengan strategi yang efektif dan terpercaya</p>
            </div>
...
<div class="neo-auth">
  <a href="https://albert-1j0.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://albert-1j0.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
