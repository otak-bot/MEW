...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> # Abarii Solusi Digital dan Layanan Teknologi Modern untuk Bisnis Berkembang</title>
<link rel="amphtml" href="https://abari.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> Abarii menyediakan solusi digital dan layanan teknologi inovatif untuk membantu bisnis berkembang lebih cepat dengan sistem modern yang efisien dan mudah digunakan">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> # Abarii Solusi Digital dan Layanan Teknologi Modern untuk Bisnis Berkembang">
<meta property="og:description" content="<?php echo $BRANDS; ?> Abarii menyediakan solusi digital dan layanan teknologi inovatif untuk membantu bisnis berkembang lebih cepat dengan sistem modern yang efisien dan mudah digunakan">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> # Abarii Solusi Digital dan Layanan Teknologi Modern untuk Bisnis Berkembang",
      "description": "<?php echo $BRANDS; ?> Abarii menyediakan solusi digital dan layanan teknologi inovatif untuk membantu bisnis berkembang lebih cepat dengan sistem modern yang efisien dan mudah digunakan",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> # Abarii Solusi Digital dan Layanan Teknologi Modern untuk Bisnis Berkembang",
      "description": "<?php echo $BRANDS; ?> Abarii menyediakan solusi digital dan layanan teknologi inovatif untuk membantu bisnis berkembang lebih cepat dengan sistem modern yang efisien dan mudah digunakan",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> # Abarii Solusi Digital dan Layanan Teknologi Modern untuk Bisnis Berkembang</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> Abarii menyediakan solusi digital dan layanan teknologi inovatif untuk membantu bisnis berkembang lebih cepat dengan sistem modern yang efisien dan mudah digunakan</p>
            </div>
...
<div class="neo-auth">
  <a href="https://abari.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://abari.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
