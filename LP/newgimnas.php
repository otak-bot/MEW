...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> # Gimnasium Ternopil Website Resmi Sekolah dengan Informasi Pendidikan dan Kegiatan Akademik</title>
<link rel="amphtml" href="https://gimnas.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> Gimnasium Ternopil menyediakan informasi pendidikan pengumuman kegiatan sekolah dan layanan akademik untuk siswa guru dan orang tua secara lengkap dan mudah diakses">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> # Gimnasium Ternopil Website Resmi Sekolah dengan Informasi Pendidikan dan Kegiatan Akademik">
<meta property="og:description" content="<?php echo $BRANDS; ?> Gimnasium Ternopil menyediakan informasi pendidikan pengumuman kegiatan sekolah dan layanan akademik untuk siswa guru dan orang tua secara lengkap dan mudah diakses">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> # Gimnasium Ternopil Website Resmi Sekolah dengan Informasi Pendidikan dan Kegiatan Akademik",
      "description": "<?php echo $BRANDS; ?> Gimnasium Ternopil menyediakan informasi pendidikan pengumuman kegiatan sekolah dan layanan akademik untuk siswa guru dan orang tua secara lengkap dan mudah diakses",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> # Gimnasium Ternopil Website Resmi Sekolah dengan Informasi Pendidikan dan Kegiatan Akademik",
      "description": "<?php echo $BRANDS; ?> Gimnasium Ternopil menyediakan informasi pendidikan pengumuman kegiatan sekolah dan layanan akademik untuk siswa guru dan orang tua secara lengkap dan mudah diakses",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> # Gimnasium Ternopil Website Resmi Sekolah dengan Informasi Pendidikan dan Kegiatan Akademik</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> Gimnasium Ternopil menyediakan informasi pendidikan pengumuman kegiatan sekolah dan layanan akademik untuk siswa guru dan orang tua secara lengkap dan mudah diakses</p>
            </div>
...
<div class="neo-auth">
  <a href="https://gimnas.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://gimnas.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
