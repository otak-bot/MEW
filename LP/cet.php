...
<meta charset="utf-8">
<title><?php echo $BRANDS; ?> # Cetec VM Kursus Online Platform Pembelajaran Digital untuk Pengembangan Skill Profesional</title>
<link rel="amphtml" href="https://cetex.pages.dev/amp/?id=<?php echo $BRANDS; ?>">
<link rel="canonical" href="<?php echo $urlPath; ?>">
<meta name="description" content="<?php echo $BRANDS; ?> Cetec VM menyediakan kursus online untuk pengembangan skill profesional dengan materi berkualitas pembelajaran fleksibel dan akses mudah kapan saja">
...
<meta property="og:title" content="<?php echo $BRANDS; ?> # Cetec VM Kursus Online Platform Pembelajaran Digital untuk Pengembangan Skill Profesional">
<meta property="og:description" content="<?php echo $BRANDS; ?> Cetec VM menyediakan kursus online untuk pengembangan skill profesional dengan materi berkualitas pembelajaran fleksibel dan akses mudah kapan saja">
        ...
        <script type="application/ld+json">
{
  ...
  "@graph": [

    {
      ...
      "name": "<?php echo $BRANDS; ?> # Cetec VM Kursus Online Platform Pembelajaran Digital untuk Pengembangan Skill Profesional",
      "description": "<?php echo $BRANDS; ?> Cetec VM menyediakan kursus online untuk pengembangan skill profesional dengan materi berkualitas pembelajaran fleksibel dan akses mudah kapan saja",
      "inLanguage": "id-ID",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Article",
      "headline": "<?php echo $BRANDS; ?> # Cetec VM Kursus Online Platform Pembelajaran Digital untuk Pengembangan Skill Profesional",
      "description": "<?php echo $BRANDS; ?> Cetec VM menyediakan kursus online untuk pengembangan skill profesional dengan materi berkualitas pembelajaran fleksibel dan akses mudah kapan saja",
      "author": {
        "@type": "Person",
...
<h1><?php echo $BRANDS; ?> # Cetec VM Kursus Online Platform Pembelajaran Digital untuk Pengembangan Skill Profesional</h1>
<p data-buy-box-listing-title="true" tabindex="0" class="wt-line-height-tight wt-break-word wt-text-body"><?php echo $BRANDS; ?> Cetec VM menyediakan kursus online untuk pengembangan skill profesional dengan materi berkualitas pembelajaran fleksibel dan akses mudah kapan saja</p>
            </div>
...
<div class="neo-auth">
  <a href="https://cetex.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-login">
    <span class="neo-icon">
  ...
  <a href="https://cetex.pages.dev/amp/?id=<?php echo $BRANDS; ?>" class="neo-btn neo-daftar">
    <span class="neo-icon">
